...
- **Text Input**: Add text anywhere on the canvas — drag to move, resize handles, color changes, undo/redo, auto-saved in whiteboard and PPT modes
...
- Auto-start on boot
- Global hotkeys (Alt+S/D/E/C/V/L/T, Alt+1~6 for quick color switching)
